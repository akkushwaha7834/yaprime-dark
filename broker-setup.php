...
<section class="broker_setup_banner">
   <div class="container">
      <div class="row">
         <div class="col-md-12">
...
<section class="white-label">
   <div class="container">
      ...
      <div class="row mt-5 align-items-center white_lable_tabs">
         <div class="col-md-6">
            <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
               <button class="nav-link active mb-3" id="v-pills-home-tab" data-bs-toggle="pill" data-bs-target="#v-pills-home" type="button" role="tab" aria-controls="v-pills-home" aria-selected="true">
                  <div class="d-flex align-items-center gap-3 mb-3">
                     ...
                     <h5 class="text-primary card-title fw-semibold mb-0">Seamless Integration</h5>
                  </div>
                  <p class="tab-para">
               ...
               <button class="nav-link mb-3" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-profile" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                  <div class="d-flex align-items-center gap-3 mb-3">
                     ...
                     <h5 class="text-primary card-title fw-semibold mb-0">Customisation</h5>
                  </div>
                  <p class="tab-para">Customise the platform to meet your needs and branding requirements, providing your clients with a unique and personalised trading experience.</p>
               </button>
               <button class="nav-link mb-3" id="v-pills-messages-tab" data-bs-toggle="pill" data-bs-target="#v-pills-messages" type="button" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                  <div class="d-flex align-items-center gap-3 mb-3">
                     ...
                     <h5 class="text-primary card-title fw-semibold mb-0">Advanced Technology</h5>
                  </div>
                  <p class="tab-para">
               ...
               <button class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill" data-bs-target="#v-pills-settings" type="button" role="tab" aria-controls="v-pills-settings" aria-selected="false">
                  <div class="d-flex align-items-center gap-3 mb-3">
                     ...
                     <h5 class="text-primary card-title fw-semibold mb-0">Cost-Efficiency</h5>
                  </div>
                  <p class="tab-para">
         ...
         <div class="col-md-6">
            <div class="tab-content" id="v-pills-tabContent">
               ...
               <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">
                  <figure class="mb-0 mx-auto">
                     <lottie-player src="images/lottie-json/cost.json" background="transparent" speed="1" direction="1" mode="normal" loop="" autoplay="">
                     </lottie-player>
                  </figure>
               </div>
            </div>
